...
export default function EditCategoryPage({ params }: EditCategoryPageProps) {
  ...
  // Получаем ID категории из params
  useEffect(() => {
    ...
    const fetchCategory = async () => {
      try {
        ...
        setFormData({
          ...
          showInMainPage: categoryData.showInMainPage || false,
  ...
  if (status === 'loading' || loading || !categoryId) {
    return (
      ...
      <div className="min-h-screen flex items-center justify-center bg-transparent">
        <div className="text-center">
          ...
          <Link
            ...
            style={{ backgroundColor: '#002c45', color: 'white' }}
          >
            Վերադառնալ կատեգորիաներին
          </Link>
        </div>
      </div>
    )
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 max-h-[calc(100vh-6rem)] overflow-y-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-3xl font-bold" style={{ color: '#002c45' }}>Խմբագրել կատեգորիան</h1>
          </div>
          <p className="opacity-80" style={{ color: '#002c45' }}>Կատեգորիայի տվյալների փոփոխում</p>
        </div>
